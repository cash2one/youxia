...
_weixin_matches = r'MicroMessenger'
_weixin_matches = re.compile(_weixin_matches, re.IGNORECASE)
...
def is_weixin_browser(self):
    user_agent = self.request.headers['User-Agent']

    if _weixin_matches.search(user_agent) != None:
        return True
